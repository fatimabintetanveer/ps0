...
public class RulesOf6005 {
    ...
    public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
    	 ...
    	 // You can use the code if you wrote it yourself.
        if (writtenByYourself) {
            return true;
        }

        // You cannot use the code if it's available to others.
        if (availableToOthers) {
            return false;
        }

        // You cannot use the code if it was written as part of 6.005 coursework.
        if (writtenAsCourseWork) {
            return false;
        }

        // You cannot use the code if you didn't properly cite your source.
        if (!citingYourSource) {
            return false;
        }

        // You cannot use the code unless the assignment specifically requires it.
        if (implementationRequired) {
            return false;
        }

        // If none of the above conditions are met, you may use the code.
        return true;
    }
